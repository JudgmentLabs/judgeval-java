...
public class JudgmentSyncClient {
    ...
    public Object addToRunEvalQueue(EvaluationRun payload) throws IOException, InterruptedException {
    ...
    public Object getEvaluationStatus(String experiment_run_id, String project_name) throws IOException, InterruptedException {
...
, queryParams
    ...
    public SavePromptScorerResponse saveScorer(SavePromptScorerRequest payload) throws IOException, InterruptedException {
    ...
    public FetchPromptScorerResponse fetchScorer(FetchPromptScorerRequest payload) throws IOException, InterruptedException {
    ...
    public ResolveProjectNameResponse projectsResolve(ResolveProjectNameRequest payload) throws IOException, InterruptedException {
