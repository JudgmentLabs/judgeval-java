...
public class JudgmentAsyncClient {
    ...
    public CompletableFuture<Object> getEvaluationStatus(String experiment_run_id, String project_name) {
...
, queryParams
    ...
    public CompletableFuture<FetchPromptScorerResponse> fetchScorer(FetchPromptScorerRequest payload) {
