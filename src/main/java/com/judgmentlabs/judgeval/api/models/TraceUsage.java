...
public class TraceUsage {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(promptTokens, other.promptTokens) && Objects.equals(completionTokens, other.completionTokens) && Objects.equals(cacheCreationInputTokens, other.cacheCreationInputTokens) && Objects.equals(cacheReadInputTokens, other.cacheReadInputTokens) && Objects.equals(totalTokens, other.totalTokens) && Objects.equals(promptTokensCostUsd, other.promptTokensCostUsd) && Objects.equals(completionTokensCostUsd, other.completionTokensCostUsd) && Objects.equals(totalCostUsd, other.totalCostUsd) && Objects.equals(modelName, other.modelName) && Objects.equals(additionalProperties, other.additionalProperties);
    }

    @Override
    public int hashCode() {
        return Objects.hashCode(promptTokens) + Objects.hashCode(completionTokens) + Objects.hashCode(cacheCreationInputTokens) + Objects.hashCode(cacheReadInputTokens) + Objects.hashCode(totalTokens) + Objects.hashCode(promptTokensCostUsd) + Objects.hashCode(completionTokensCostUsd) + Objects.hashCode(totalCostUsd) + Objects.hashCode(modelName) + Objects.hashCode(additionalProperties);
    }
}