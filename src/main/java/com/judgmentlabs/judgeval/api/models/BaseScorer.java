...
public class BaseScorer {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(scoreType, other.scoreType) && Objects.equals(threshold, other.threshold) && Objects.equals(name, other.name) && Objects.equals(className, other.className) && Objects.equals(score, other.score) && Objects.equals(scoreBreakdown, other.scoreBreakdown) && Objects.equals(reason, other.reason) && Objects.equals(usingNativeModel, other.usingNativeModel) && Objects.equals(success, other.success) && Objects.equals(model, other.model) && Objects.equals(modelClient, other.modelClient) && Objects.equals(strictMode, other.strictMode) && Objects.equals(error, other.error) && Objects.equals(additionalMetadata, other.additionalMetadata) && Objects.equals(user, other.user) && Objects.equals(serverHosted, other.serverHosted) && Objects.equals(additionalProperties, other.additionalProperties);
    }

    @Override
    public int hashCode() {
        return Objects.hashCode(scoreType) + Objects.hashCode(threshold) + Objects.hashCode(name) + Objects.hashCode(className) + Objects.hashCode(score) + Objects.hashCode(scoreBreakdown) + Objects.hashCode(reason) + Objects.hashCode(usingNativeModel) + Objects.hashCode(success) + Objects.hashCode(model) + Objects.hashCode(modelClient) + Objects.hashCode(strictMode) + Objects.hashCode(error) + Objects.hashCode(additionalMetadata) + Objects.hashCode(user) + Objects.hashCode(serverHosted) + Objects.hashCode(additionalProperties);
    }
}