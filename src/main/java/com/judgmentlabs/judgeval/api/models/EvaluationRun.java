...
public class EvaluationRun {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(id, other.id) && Objects.equals(projectName, other.projectName) && Objects.equals(evalName, other.evalName) && Objects.equals(examples, other.examples) && Objects.equals(customScorers, other.customScorers) && Objects.equals(judgmentScorers, other.judgmentScorers) && Objects.equals(model, other.model) && Objects.equals(traceSpanId, other.traceSpanId) && Objects.equals(traceId, other.traceId) && Objects.equals(createdAt, other.createdAt) && Objects.equals(additionalProperties, other.additionalProperties);
    }

    @Override
    public int hashCode() {
        return Objects.hashCode(id) + Objects.hashCode(projectName) + Objects.hashCode(evalName) + Objects.hashCode(examples) + Objects.hashCode(customScorers) + Objects.hashCode(judgmentScorers) + Objects.hashCode(model) + Objects.hashCode(traceSpanId) + Objects.hashCode(traceId) + Objects.hashCode(createdAt) + Objects.hashCode(additionalProperties);
    }
}