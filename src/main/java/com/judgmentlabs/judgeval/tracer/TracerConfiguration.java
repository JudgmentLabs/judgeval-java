 ...
 *
 * <p>This class encapsulates all configuration parameters needed to initialize a {@link Tracer}. It
 * provides a builder pattern for easy configuration and validation of required parameters.
 *
 * <p>Example usage:
 *
 * <pre>{@code
...
public final class TracerConfiguration {
     ...
     *
     * <p>When enabled, the tracer will automatically evaluate spans using configured scorers. When
     * disabled, evaluation calls will be ignored.
     *
     ...
     *
     * <p>This builder provides a fluent API for configuring all aspects of the tracer. All fields
     * have sensible defaults, so only the project name is strictly required.
     *
     * <p>Example usage:
     *
     * <pre>{@code
    ...
    public static final class Builder {
         ...
         *
         * <p>The project name is used to identify your project in the Judgment Labs dashboard. It
         ...
         *
         * <p>The API key is used to authenticate requests to Judgment Labs services. You can find
         * your API key in the Judgment Labs dashboard.
         *
         ...
         *
         * <p>The organization ID identifies your organization within Judgment Labs. This is
         * typically provided when you set up your account.
         *
         ...
         *
         * <p>This is typically only needed for custom deployments or testing. The default URL
         * points to the production Judgment Labs API.
         *
         ...
         *
         * <p>When enabled, the tracer will automatically evaluate spans using configured scorers.
         * When disabled, evaluation calls will be ignored, which can be useful for testing or when
         * you want to disable evaluation temporarily.
         *
         ...
         *
         * <p>This method validates all required fields and creates an immutable TracerConfiguration
         * instance.
         *
