 ...
 * </p>
 * <ul>
 * <li>Export OpenTelemetry spans to Judgment Labs</li>
 * <li>Automatically evaluate spans using configured scorers</li>
 * <li>Set custom attributes on spans for better observability</li>
 * <li>Integrate with existing OpenTelemetry instrumentation</li>
 * </ul>
 * 
 * <p>
 * This class is designed to work seamlessly with OpenTelemetry and provides
 * a SpanExporter that can be used with any OpenTelemetry SDK.
 * </p>
 * 
 * <h3>Basic Usage</h3>
 * 
...
public final class Tracer {
     ...
     * @param gson          the Gson instance for JSON serialization (must not be
     *                      null)
     ...
     * 
     * <p>
     * This builder allows you to inject custom dependencies like API clients
     * and Gson instances, which is useful for testing or advanced use cases.
     * </p>
     * 
     ...
     * 
     * <p>
     * This is the simplest way to create a Tracer. It uses default values
     * from environment variables and enables evaluation by default.
     * </p>
     * 
     ...
     * 
     * <p>
     * This method allows you to use a pre-configured TracerConfiguration
     * instance, which is useful when you want to reuse configuration across
     * multiple tracers or when you have complex configuration requirements.
     * </p>
     * 
     * @param configuration the tracer configuration (must not be null)
     ...
     * 
     * <p>
     * This method returns a SpanExporter that can be used with any OpenTelemetry
     * SDK.
     * </p>
     * 
     * <p>
     * If the project ID cannot be resolved (e.g., the project doesn't exist),
     * this method returns a NoOpSpanExporter.
     * </p>
     * 
     * <p>
     * Example usage:
     ...
     *         NoOpSpanExporter if project resolution fails
     */
     ...
     * 
     * <p>
     * This method sets a special attribute that identifies the type of span
     * for better categorization in the Judgment Labs dashboard.
     * </p>
     * 
     * <p>
     ...
     * </p>
     * <ul>
     * <li>"span" - General application spans</li>
     * <li>"llm" - Language model interactions</li>
     * <li>"tool" - External tool or API calls</li>
     * </ul>
     * 
    ...
    public void setSpanKind(String kind) {
        Optional.ofNullable(Span.current())
                ...
                .ifPresent(span -> span.setAttribute(OpenTelemetryKeys.AttributeKeys.JUDGMENT_SPAN_KIND, kind));
    }
     ...
     * 
     * <p>
     * This method serializes the value to JSON and sets it as a string attribute
     * on the current span. This is useful for adding custom metadata to spans
     ...
     * you to specify the type for JSON serialization. This is useful when you need
     * to preserve type information or when dealing with generic types.
     * </p>
     * 
     * <p>
     * If there is no current span, this method does nothing.
     ...
     * 
     * <p>
     * This method submits an evaluation request to Judgment Labs for processing.
     * The evaluation is performed asynchronously and the results will be available
     * in the Judgment Labs dashboard.
     * </p>
     * 
     * <p>
     ...
     * </p>
     * <ul>
     * <li>The current trace and span context for correlation</li>
     * <li>The scorer configuration and threshold</li>
     * <li>The example input and output data</li>
     * <li>The model used for generation</li>
     * </ul>
     * 
     * <p>
     * If evaluation is disabled in the configuration, this method does nothing.
     * </p>
     * 
    ...
    public void asyncEvaluate(BaseScorer scorer, Example example, String model, double samplingRate) {
        ...
        SpanContext spanContext = Optional.ofNullable(Span.current())
        ...
        Logger.info("asyncEvaluate: project=" + configuration.projectName() + ", traceId=" + traceId + ", spanId="
                + spanId + ", scorerTransport=" + (transport != null ? transport.getClass().getSimpleName() : "null"));
     ...
     * 
     * <p>
     * This method makes an API call to Judgment Labs to resolve the project name
     * to a project ID. If the project doesn't exist, this method returns null.
     * </p>
     * 
     ...
     */
    private EvaluationRun createEvaluationRun(BaseScorer scorer, Example example, String model, String traceId,
            String spanId) {
    ...
    public static final class TracerBuilder {
         ...
         * 
         * <p>
         * This is useful when you need custom JSON serialization behavior
         * or when you want to reuse an existing Gson instance.
         * </p>
         * 
         ...
         * 
         * <p>
         * This method validates the configuration and creates a new Tracer instance.
         * If no custom API client is provided, a default one will be created using
        ...
        public Tracer build() {
            ...
            JudgmentSyncClient client = apiClient != null ? apiClient
                    : new JudgmentSyncClient(configuration.apiUrl(), configuration.apiKey(),
                            configuration.organizationId());
