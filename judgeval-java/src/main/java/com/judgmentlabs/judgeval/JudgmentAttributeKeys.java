...
public final class JudgmentAttributeKeys {
    public static final class AttributeKeys {
        ...
        public static final String JUDGMENT_PENDING_TRACE_EVAL              = "judgment.pending_trace_eval";
